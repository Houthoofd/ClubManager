...
export const userSchema = z.object({
  ...
  date_inscription: z.string().refine((val: string) => !isNaN(Date.parse(val)), "La date d'inscription est invalide"),
});
...
export const utilisateurInscriptionSchema = z.object({
  ...
  date_inscription: z.preprocess(
    ...
    z.string().refine((val: string) => !isNaN(Date.parse(val)), "La date d'inscription est invalide")
  ),
