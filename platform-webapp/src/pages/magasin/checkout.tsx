...
import CheckoutForm, { CheckoutFormData } from '../../components/magasin/CheckoutForm';
import StripePaymentForm from '../../components/magasin/StripePaymentForm';
...
const CheckoutPage: React.FC = () => {
  ...
  const calculerTotal = () => {
    return panier.reduce((total, article) => total + (article.prix * (article.quantite || 1)), 0);
  };
