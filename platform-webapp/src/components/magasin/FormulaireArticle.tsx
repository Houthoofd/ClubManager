...
import { PriceInput } from '../common/input/numberInput';
import NumberInputDefault from '../common/input/NumberInputDefault';
...
const FormulaireArticle: React.FC<FormulaireArticleProps> = ({
  ...
  const handleAddTaille = () => {
    ...
    updated.sort((a, b) => taillesDisponibles.indexOf(a.taille) - taillesDisponibles.indexOf(b.taille));
