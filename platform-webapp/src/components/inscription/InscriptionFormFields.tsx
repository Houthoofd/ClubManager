...
import { FormData, ValidationState } from '../../types/inscriptionTypes';
  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
        <FormGroup label="Prénom" isRequired fieldId="prenom" validated={validation.prenom?.validated}>
          <TextInput
            id="prenom"
            value={form.prenom}
      ...
      {/* Mot de passe */}
      <FormGroup label="Mot de passe" isRequired fieldId="password" validated={validation.password?.validated}>
        <TextInput
          type="password"
          id="password"
          value={form.password}
      ...
      <FormGroup label="Confirmer le mot de passe" isRequired fieldId="confirmPassword" validated={validation.confirmPassword?.validated}>
        <TextInput
          type="password"
          id="confirmPassword"
      ...
      {/* Date de naissance */}
      <FormGroup label="Date de naissance" isRequired fieldId="date_naissance" validated={validation.date_naissance?.validated}>
        <TextInput
          type="date"
          id="date_naissance"
