...
router.patch('/modifier', async (req, res) => {
    try {
        ...
        try {
            ...
            const coursRecurrentId = await cours.obtenirIdCoursRecurrent(jour_original || jour, type_cours_original || type_cours, heure_debut_original || heure_debut, heure_fin_original || heure_fin);
