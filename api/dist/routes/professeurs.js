    ...
    try {
        ...
        const extractUserIds = (data) => {
            ...
            if (data.utilisateurs && Array.isArray(data.utilisateurs)) {
                ...
                if (data.utilisateurs.every((item) => typeof item === 'string' || typeof item === 'number')) {
                    console.log('🔍 [extractUserIds] Cas 1a: Tableau d\'IDs directs (strings/numbers)');
                    userIds = data.utilisateurs.map((id) => {
                ...
                // Sinon c'est un tableau d'objets
                    ...
                    userIds = data.utilisateurs.map((user) => {
