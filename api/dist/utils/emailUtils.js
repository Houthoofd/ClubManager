export class EmailUtils {
    ...
    static formatDateForEmail(date) {
    ...
    static calculateEmailDelay(emailCount) {
    ...
    static chunkEmails(emails, maxBatchSize = 50) {
        const chunks = [];
    ...
    static logEmailActivity(action, recipient, success, details) {
