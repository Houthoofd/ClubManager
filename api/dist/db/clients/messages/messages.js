...
${content}`;
    ...
    async envoyerRappelPaiementAvecEmail(echeanceIds, messagePersonnalise = '') {
        try {
    ...
    async obtenirUtilisateurDepuisEcheance(echeanceId) {
        try {
    ...
    async calculerMontantEcheances(echeanceIds) {
        try {
