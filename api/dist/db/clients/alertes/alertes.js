...
export class Alerte {
    ...
    async obtenirDashboardAlertes() {
        return new Promise((resolve, reject) => {
            this.mysqlConnector.query('CALL obtenir_dashboard_alertes()', [], (error, results) => {
                if (error) {
    ...
    async obtenirAlertesUtilisateur(userId) {
        return new Promise((resolve, reject) => {
            this.mysqlConnector.query('CALL obtenir_alertes_utilisateur(?)', [userId], (error, results) => {
                if (error) {
    ...
    async detecterAlertes() {
        return new Promise((resolve, reject) => {
            this.mysqlConnector.query('CALL detecter_alertes_utilisateurs()', [], (error, results) => {
                if (error) {
    ...
    async resoudreAlerte(alerteId, notes, effectuePar) {
        return new Promise((resolve, reject) => {
            this.mysqlConnector.query('CALL resoudre_alerte(?, ?, ?)', [alerteId, notes, effectuePar], (error, results) => {
                if (error) {
    ...
    async ignorerAlerte(alerteId, notes) {
        return new Promise((resolve, reject) => {
            const query = `
        ...
        WHERE id = ?
      `;
            this.mysqlConnector.query(query, [notes, alerteId], (error, results) => {
                if (error) {
    ...
    async obtenirStatistiquesAlertes() {
        return new Promise((resolve, reject) => {
            const query = `
        SELECT 
