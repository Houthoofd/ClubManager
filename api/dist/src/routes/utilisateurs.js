...
router.post('/inscription', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const client = new Utilisateurs();
        const result = yield client.inscrireUtilisateur(validatedData.prenom, validatedData.nom, validatedData.nom_utilisateur, validatedData.email, validatedData.genre_id, validatedData.date_naissance, validatedData.password, validatedData.status_id, validatedData.grade_id, validatedData.abonnement_id);
