...
export class EmailTemplateService {
    ...
    async upsertTemplate(title, content) {
        return new Promise((resolve, reject) => {
            const sql = `
    ...
    async getTemplateByTitle(title) {
        await this.ensureInitialized();
        return new Promise((resolve, reject) => {
            const sql = `
        SELECT id, title, content, created_at, updated_at
    ...
    async createTemplate(title, content) {
        await this.ensureInitialized();
        return new Promise((resolve, reject) => {
            const sql = `
        INSERT INTO types_messages_personnalises (title, content)
    ...
    async updateTemplate(id, title, content) {
        await this.ensureInitialized();
        return new Promise((resolve, reject) => {
            const sql = `
    ...
    async getPaymentReminderTemplate(level, variables) {
        const templateNames = {
    ...
    createDefaultWelcomeTemplate(variables) {
        return {
    ...
    createDefaultPasswordResetTemplate(variables) {
        return {
    ...
    createDefaultCourseNotificationTemplate(variables) {
        return {
    ...
    createDefaultPaymentReminderTemplate(level, variables) {
        const urgencyLevel = {
    ...
    createDefaultPaymentConfirmationTemplate(variables) {
        return {
    ...
    createDefaultEmailValidationTemplate(variables) {
        return {
