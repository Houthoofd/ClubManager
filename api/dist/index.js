...
console.log('🔍 [Server] Vérification configuration Stripe au démarrage:', {
    ...
    STRIPE_SECRET_KEY_type: process.env.STRIPE_SECRET_KEY ? (process.env.STRIPE_SECRET_KEY.startsWith('sk_test_') ? 'SECRET TEST' :
    ...
    STRIPE_PUBLIC_KEY_type: process.env.STRIPE_PUBLIC_KEY ? (process.env.STRIPE_PUBLIC_KEY.startsWith('pk_test_') ? 'PUBLIC TEST' :
