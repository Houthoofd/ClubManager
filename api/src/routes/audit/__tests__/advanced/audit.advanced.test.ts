 ...
 * 🎯 Tests Avancés - Audit
 *
 * Tests des cas limites et scénarios complexes pour audit
 */

import { AuditService } from "../../core/services/audit.service";
import { prisma } from "@/infrastructure/database/prisma-client";

describe("Audit - Tests Avancés", () => {
  ...
  describe("Gestion des erreurs", () => {
    it("devrait gérer les erreurs de base de données", async () => {
      ...
      jest.spyOn(prisma.audit, 'findMany').mockRejectedValue(
  ...
  describe("Performance", () => {
    it("devrait gérer de grandes quantités de données", async () => {
      ...
      jest.spyOn(prisma.audit, 'findMany').mockResolvedValue(largeDataset as any);
