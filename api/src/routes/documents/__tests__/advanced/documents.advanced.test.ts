/**
 * 🎯 Tests Avancés - Documents
 *
 * Tests des cas limites et scénarios complexes pour documents
 */

import { DocumentsService } from "../../core/services/documents.service";
import { prisma } from "@/infrastructure/database/prisma-client";

describe("Documents - Tests Avancés", () => {
  ...
  describe("Gestion des erreurs", () => {
    it("devrait gérer les erreurs de base de données", async () => {
      ...
      jest.spyOn(prisma.documents, 'findMany').mockRejectedValue(
  ...
  describe("Performance", () => {
    it("devrait gérer de grandes quantités de données", async () => {
      ...
      jest.spyOn(prisma.documents, 'findMany').mockResolvedValue(largeDataset as any);
