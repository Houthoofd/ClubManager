/**
 * 🎯 Tests Avancés - Activities
 *
 * Tests des cas limites et scénarios complexes pour activities
 */

import { ActivitiesService } from "../../core/services/activities.service";
import { prisma } from "@/infrastructure/database/prisma-client";

describe("Activities - Tests Avancés", () => {
  ...
  describe("Gestion des erreurs", () => {
    it("devrait gérer les erreurs de base de données", async () => {
      ...
      jest.spyOn(prisma.activities, 'findMany').mockRejectedValue(
  ...
  describe("Performance", () => {
    it("devrait gérer de grandes quantités de données", async () => {
      ...
      jest.spyOn(prisma.activities, 'findMany').mockResolvedValue(largeDataset as any);
