/**
 * 🧪 Tests d'Intégration - Shop
 *
 * Tests d'intégration avec base de données pour shop
 */
...
describe("Shop - Tests d'Intégration", () => {
  ...
  describe("Cycle de vie complet", () => {
    it("devrait créer, lire, mettre à jour et supprimer un shop", async () => {
      // CREATE
