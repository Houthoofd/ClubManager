 ...
 * 🎯 Tests Avancés - Shop
 *
 * Tests des cas limites et scénarios complexes pour shop
 */

import { ShopService } from "../../core/services/shop.service";
import { prisma } from "@/infrastructure/database/prisma-client";

describe("Shop - Tests Avancés", () => {
  ...
  describe("Gestion des erreurs", () => {
    it("devrait gérer les erreurs de base de données", async () => {
      ...
      jest.spyOn(prisma.shop, 'findMany').mockRejectedValue(
  ...
  describe("Performance", () => {
    it("devrait gérer de grandes quantités de données", async () => {
      ...
      jest.spyOn(prisma.shop, 'findMany').mockResolvedValue(largeDataset as any);
