...
export const authResolvers = (prisma: PrismaClient) => ({
  Query: {
     ...
     */
    verifyAuth: async (_: any, __: any, context: Context) => {
      if (!context.user) {
