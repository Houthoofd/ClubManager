 ...
 * 🎯 Tests Avancés - Users
 *
 * Tests des cas limites et scénarios complexes pour users
 */

import { UsersService } from "../../core/services/users.service";
import { prisma } from "@/infrastructure/database/prisma-client";

describe("Users - Tests Avancés", () => {
  ...
  describe("Gestion des erreurs", () => {
    it("devrait gérer les erreurs de base de données", async () => {
      ...
      jest.spyOn(prisma.users, 'findMany').mockRejectedValue(
  ...
  describe("Performance", () => {
    it("devrait gérer de grandes quantités de données", async () => {
      ...
      jest.spyOn(prisma.users, 'findMany').mockResolvedValue(largeDataset as any);
