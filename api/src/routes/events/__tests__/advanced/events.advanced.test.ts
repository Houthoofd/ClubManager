/**
 * 🎯 Tests Avancés - Events
 *
 * Tests des cas limites et scénarios complexes pour events
 */

import { EventsService } from "../../core/services/events.service";
import { prisma } from "@/infrastructure/database/prisma-client";

describe("Events - Tests Avancés", () => {
  ...
  describe("Gestion des erreurs", () => {
    it("devrait gérer les erreurs de base de données", async () => {
      ...
      jest.spyOn(prisma.events, 'findMany').mockRejectedValue(
  ...
  describe("Performance", () => {
    it("devrait gérer de grandes quantités de données", async () => {
      ...
      jest.spyOn(prisma.events, 'findMany').mockResolvedValue(largeDataset as any);
