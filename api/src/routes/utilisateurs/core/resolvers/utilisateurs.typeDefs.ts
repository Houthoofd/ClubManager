...
export const utilisateursTypeDefs = `
  # Types de base
  type Utilisateur {
    id: Int!
    prenom: String!
  ...
  type Query {
    ...
    # Récupérer tous les utilisateurs (auth requise)
    getUtilisateurs(includeInactive: Boolean): [Utilisateur!]!

    # Récupérer un utilisateur par ID (auth requise)
    getUtilisateur(id: Int!): Utilisateur!

    # Récupérer les statistiques des utilisateurs (auth requise)
