/**
 * 🎯 Tests Avancés - Settings
 *
 * Tests des cas limites et scénarios complexes pour settings
 */

import { SettingsService } from "../../core/services/settings.service";
import { prisma } from "@/infrastructure/database/prisma-client";

describe("Settings - Tests Avancés", () => {
  ...
  describe("Gestion des erreurs", () => {
    it("devrait gérer les erreurs de base de données", async () => {
      ...
      jest.spyOn(prisma.settings, 'findMany').mockRejectedValue(
  ...
  describe("Performance", () => {
    it("devrait gérer de grandes quantités de données", async () => {
      ...
      jest.spyOn(prisma.settings, 'findMany').mockResolvedValue(largeDataset as any);
