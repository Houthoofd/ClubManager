 ...
 *   import { SELECT_ALL_ARTICLES_WITH_RELATIONS } from './queries/read.queries.js';
 *   import { INSERT_ARTICLE } from './queries/write.queries.js';
 *   import { CHECK_ARTICLE_EXISTS } from './queries/validation.queries.js';
 */
