...
export class Auth {
  ...
  authentifierUtilisateur(email: string, password: string): Promise<any> {
    return new Promise((resolve, reject) => {
      const sql = `
  ...
  creerCompteUtilisateur(userData: any): Promise<ConfirmationResult> {
    return new Promise((resolve, reject) => {
      const sql = `
  ...
  modifierMotDePasse(userId: number, newPasswordHash: string): Promise<ConfirmationResult> {
    return new Promise((resolve, reject) => {
      const sql = `
        UPDATE utilisateurs 
        SET password_hash = ?
      ...
      this.mysqlConnector.query(sql, [newPasswordHash, userId], (error, results: any) => {
        if (error) {
  ...
  verifierTentativesRecuperationRecentes(email: string, minutes: number = 15): Promise<number> {
    return new Promise((resolve, reject) => {
      const sql = `
  ...
  rechercherUtilisateurParEmail(email: string): Promise<any> {
    return new Promise((resolve, reject) => {
      const sql = `
  ...
  obtenirInformationsSecurite(userId: number): Promise<any> {
    return new Promise((resolve, reject) => {
      const sql = `
        SELECT 
  ...
  creerTokenRecuperation(userId: number, token: string, expiresAt: Date): Promise<ConfirmationResult> {
    return new Promise((resolve, reject) => {
  ...
  verifierTokenRecuperation(token: string): Promise<any> {
    return new Promise((resolve, reject) => {
      const sql = `
  ...
  marquerTokenUtilise(token: string): Promise<ConfirmationResult> {
    return new Promise((resolve, reject) => {
      const sql = `
        DELETE FROM password_reset_tokens 
        WHERE token = ?
      ...
      this.mysqlConnector.query(sql, [token], (error, results: any) => {
        if (error) {
  ...
  reinitialiserMotDePasseAvecToken(token: string, newPasswordHash: string): Promise<ConfirmationResult> {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        this.mysqlConnector.query(updatePasswordSql, [newPasswordHash, tokenData.user_id], (updateError, updateResults: any) => {
          if (updateError) {
  ...
  nettoyerTokensExpires(): Promise<ConfirmationResult> {
    return new Promise((resolve, reject) => {
      const sql = `
        DELETE FROM password_reset_tokens 
        WHERE expires_at < ?
      ...
      this.mysqlConnector.query(sql, [now], (error, results: any) => {
        if (error) {
  ...
  obtenirTentativesConnexionRecentes(email: string, minutes: number = 15): Promise<number> {
    return new Promise((resolve, reject) => {
      const sql = `
        SELECT COUNT(*) as count
        FROM auth_attempts
  ...
  enregistrerTentativeRecuperation(email: string, success: boolean): Promise<void> {
    return new Promise((resolve, reject) => {
      const sql = `
  ...
  enregistrerTentativeConnexion(email: string, success: boolean): Promise<void> {
    return new Promise((resolve, reject) => {
      const sql = `
  ...
  creerDemandeRecuperationManuelle(userId: number, raison: string, informationsVerification: any): Promise<ConfirmationResult> {
    return new Promise((resolve, reject) => {
      const sql = `
  ...
  static validerMotDePasse(password: string): { valid: boolean; errors: string[] } {
    const errors: string[] = [];
