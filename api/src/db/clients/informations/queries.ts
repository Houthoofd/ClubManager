 ...
 *   import { SELECT_ALL_INFORMATIONS } from './queries/read.queries.js';
 *   import { INSERT_INFORMATION } from './queries/write.queries.js';
 *   import { CHECK_INFORMATION_EXISTS } from './queries/validation.queries.js';
 */
