 ...
 *   import { SELECT_ALL_TYPES_MESSAGES } from './queries/read.queries.js';
 *   import { INSERT_MESSAGE_PERSONNALISE } from './queries/write.queries.js';
 *   import { CHECK_MESSAGE_EXISTS } from './queries/validation.queries.js';
 */
