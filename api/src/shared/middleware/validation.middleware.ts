...
import { ValidationError } from "../errors/GraphQLErrors.js";
...
/**
 * Validation middleware with currying support
 */
...
/**
 * Middleware for nested object validation with currying support
 */
export function withNestedValidation<
  TArgs = any,
  TContext = any,
  TResult = any,
      ...
      try {
        ...
        for (const [key, schema] of Object.entries(schemas)) {
          if (validatedArgs[key] !== undefined) {
            validatedArgs[key] = await schema.parseAsync(validatedArgs[key]);
          }
        }
