/**
 * Template for GraphQL hook tests (useQuery, useMutation, etc.)
 */

export function generateGraphQLHookTest(analysis, importPath) {
...
describe('${hookName}', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should accept initial variables', () => {
      ...
      const { result } = renderHook(() => ${hookName}(variables), { wrapper });
...
export default generateGraphQLHookTest;
