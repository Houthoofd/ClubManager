...
import GraphiquePie from '../common/graph/GraphiquePie';
import TableauStatistiques from '../common/table/TableauStatistiques';
import SwitchViewControls from '../common/controls/SwitchViewControls';
