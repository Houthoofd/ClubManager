/**
 * Tests for MessageStats.tsx
 *
 * @file MessageStats.tsx
 * @type component
...
describe('MessageStats', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<MessageStats {...defaultProps} showDetails={true} />);      // Element should now be visible
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<MessageStats {...defaultProps} value="updated" />);      // Updated value should be reflected
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<MessageStats {...defaultProps} />);      // Component should not re-render unnecessarily
    });
