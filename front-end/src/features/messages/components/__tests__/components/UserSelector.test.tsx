...
describe('UserSelector', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<UserSelector {...defaultProps} showDetails={true} />);      // Element should now be visible
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<UserSelector {...defaultProps} value="updated" />);      // Updated value should be reflected
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<UserSelector {...defaultProps} />);      // Component should not re-render unnecessarily
    });
