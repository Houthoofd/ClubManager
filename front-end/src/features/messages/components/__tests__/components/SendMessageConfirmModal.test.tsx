/**
 * Tests for SendMessageConfirmModal.tsx
 *
 * @file SendMessageConfirmModal.tsx
 * @type component
...
import { SendMessageConfirmModal } from '../../SendMessageConfirmModal';
...
describe('SendMessageConfirmModal', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <SendMessageConfirmModal {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<SendMessageConfirmModal {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<SendMessageConfirmModal {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<SendMessageConfirmModal {...defaultProps} />);
