/**
 * Tests for MessagesReceivedTab.tsx
 *
 * @file MessagesReceivedTab.tsx
 * @type component
...
import { MessagesReceivedTab } from '../../MessagesReceivedTab';
...
describe('MessagesReceivedTab', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <MessagesReceivedTab {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<MessagesReceivedTab {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<MessagesReceivedTab {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<MessagesReceivedTab {...defaultProps} />);
