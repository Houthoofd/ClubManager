/**
 * Tests for ReadMessagesContent.tsx
 *
 * @file ReadMessagesContent.tsx
 * @type component
...
import { ReadMessagesContent } from '../../ReadMessagesContent';
...
describe('ReadMessagesContent', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <ReadMessagesContent {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<ReadMessagesContent {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<ReadMessagesContent {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<ReadMessagesContent {...defaultProps} />);
