/**
 * Tests for ReceivedMessagesContent.tsx
 *
 * @file ReceivedMessagesContent.tsx
 * @type component
...
describe('ReceivedMessagesContent', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <ReceivedMessagesContent {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<ReceivedMessagesContent {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<ReceivedMessagesContent {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<ReceivedMessagesContent {...defaultProps} />);
