/**
 * Tests for OngletStatistiques.tsx
 *
 * @file OngletStatistiques.tsx
 * @type component
...
describe('OngletStatistiques', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <OngletStatistiques {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<OngletStatistiques {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<OngletStatistiques {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<OngletStatistiques {...defaultProps} />);
