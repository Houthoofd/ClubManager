/**
 * Tests for ExpandableDataSection.tsx
 *
 * @file ExpandableDataSection.tsx
 * @type component
...
describe('ExpandableDataSection', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <ExpandableDataSection {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<ExpandableDataSection {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<ExpandableDataSection {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<ExpandableDataSection {...defaultProps} />);
