/**
 * Tests for DetailArticleModal.tsx
 *
 * @file DetailArticleModal.tsx
 * @type component
...
describe('DetailArticleModal', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <DetailArticleModal {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<DetailArticleModal {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<DetailArticleModal {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<DetailArticleModal {...defaultProps} />);
