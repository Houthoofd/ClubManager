...
describe('useArticlesParCategorie', () => {
  describe('Initialization', () => {
    it('should initialize with default values', () => {
      const { result } = renderHook(() => useArticlesParCategorie());
    ...
    it('should accept initial parameters', () => {
      ...
      const { result } = renderHook(() => useArticlesParCategorie(/* params */));
  ...
  describe('Edge Cases', () => {
    it('should handle invalid input gracefully', () => {
      const { result } = renderHook(() => useArticlesParCategorie(/* invalid input */));
