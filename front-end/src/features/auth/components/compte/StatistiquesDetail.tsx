...
const StatistiquesDetail: React.FC<StatistiquesDetailProps> = ({
  ...
  return (
    ...
    >
      {statFrequentationForGraph.mois.map((item: MoisData, index: number) => {
        const monthKey = `month-${index}`;
        const isExpanded = expandedMonths[monthKey] || false;
        const translatedMonth = translateMonth(
          item?.mois || `Mois ${index + 1}`,
        );
        ...
        return (
          <Card key={index} style={{ padding: "0.5rem", width: "100%" }}>
            <div>
              ...
              >
                <span style={{ fontWeight: "500" }}>{translatedMonth}</span>
                ...
                <CardBody style={{ paddingTop: "1rem" }}>
                  ...
                  >
                    ...
                    <FlexItem>
                      ...
                      >
                        Cours total :{" "}
                        {item?.nombres_total_de_cours_du_mois || 0}
                      </span>
                    </FlexItem>
