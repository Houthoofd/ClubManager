...
import EcheancesPaiement from "@/features/users/components/EcheancesPaiement";
...
const PaiementsTab: React.FC<PaiementsTabProps> = ({
  ...
  if (
    echeancesSafe.errorEcheances &&
    (echeancesSafe.errorEcheances.message?.includes("403") ||
      echeancesSafe.errorEcheances.message?.includes("401"))
  ) {
    return (
      <div style={{ textAlign: "center", padding: "2rem" }}>
        ...
        >
          <h3 style={{ color: "#e17055", margin: "0 0 1rem 0" }}>🔒 Problème d'authentification</h3>
