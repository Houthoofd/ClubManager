/**
 * Tests for StatistiquesDetail.tsx
 *
 * @file StatistiquesDetail.tsx
 * @type component
...
describe('StatistiquesDetail', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <StatistiquesDetail {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<StatistiquesDetail {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<StatistiquesDetail {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<StatistiquesDetail {...defaultProps} />);
