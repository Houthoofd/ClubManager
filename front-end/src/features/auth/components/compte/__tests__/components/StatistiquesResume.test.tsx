/**
 * Tests for StatistiquesResume.tsx
 *
 * @file StatistiquesResume.tsx
 * @type component
...
describe('StatistiquesResume', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <StatistiquesResume {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<StatistiquesResume {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<StatistiquesResume {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<StatistiquesResume {...defaultProps} />);
