/**
 * Tests for CompteInfoTab.tsx
 *
 * @file CompteInfoTab.tsx
 * @type component
...
describe('CompteInfoTab', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<CompteInfoTab {...defaultProps} showDetails={true} />);      // Element should now be visible
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<CompteInfoTab {...defaultProps} value="updated" />);      // Updated value should be reflected
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<CompteInfoTab {...defaultProps} />);      // Component should not re-render unnecessarily
    });
