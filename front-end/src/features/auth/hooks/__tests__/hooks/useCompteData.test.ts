/**
 * Tests for useCompteData.ts
 *
 * @file useCompteData.ts
 * @type hook
...
import { useCompteData } from '../../useCompteData';
...
describe('useCompteData', () => {
  ...
  describe('Cleanup', () => {
    it('should cleanup on unmount', () => {
      const { unmount } = renderHook(() => useCompteData());
  ...
  describe('Performance', () => {
    it('should not cause unnecessary re-renders', () => {
      const { result, rerender } = renderHook(() => useCompteData());
