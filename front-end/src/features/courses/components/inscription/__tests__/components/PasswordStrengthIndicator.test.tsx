/**
 * Tests for PasswordStrengthIndicator.tsx
 *
...
describe('PasswordStrengthIndicator', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <PasswordStrengthIndicator {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<PasswordStrengthIndicator {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<PasswordStrengthIndicator {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<PasswordStrengthIndicator {...defaultProps} />);
