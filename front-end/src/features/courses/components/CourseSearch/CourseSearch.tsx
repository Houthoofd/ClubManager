 ...
 *
 * Search bar and results information for filtering courses.
...
export const CourseSearch: React.FC<CourseSearchProps> = ({
  ...
  const defaultPlaceholder = t("courses.list.search");
      ...
      {showInfo && (
        <div style={{ marginBottom: "1rem" }}>
          <span style={{ fontSize: "0.875rem", color: "#6a6e73" }}>
            {resultsCount} cours trouvé{resultsCount !== 1 ? "s" : ""} sur {totalCount}
          </span>
        </div>
      )}
    </div>
