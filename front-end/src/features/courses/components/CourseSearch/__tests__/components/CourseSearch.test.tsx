/**
 * Tests for CourseSearch.tsx
 *
 * @file CourseSearch.tsx
 * @type component
...
describe('CourseSearch', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<CourseSearch {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<CourseSearch {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<CourseSearch {...defaultProps} />);
