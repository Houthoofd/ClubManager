...
describe('ParticipantCard', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<ParticipantCard {...defaultProps} showDetails={true} />);      // Element should now be visible
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<ParticipantCard {...defaultProps} value="updated" />);      // Updated value should be reflected
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<ParticipantCard {...defaultProps} />);      // Component should not re-render unnecessarily
    });
