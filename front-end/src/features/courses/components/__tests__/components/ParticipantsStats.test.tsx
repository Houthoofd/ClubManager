/**
 * Tests for ParticipantsStats.tsx
 *
 * @file ParticipantsStats.tsx
 * @type component
...
describe('ParticipantsStats', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<ParticipantsStats {...defaultProps} showDetails={true} />);      // Element should now be visible
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<ParticipantsStats {...defaultProps} value="updated" />);      // Updated value should be reflected
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<ParticipantsStats {...defaultProps} />);      // Component should not re-render unnecessarily
    });
