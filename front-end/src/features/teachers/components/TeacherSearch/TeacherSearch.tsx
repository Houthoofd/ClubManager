 ...
 *
 * Search bar and results information for filtering teachers.
...
export const TeacherSearch: React.FC<TeacherSearchProps> = ({
  ...
  const defaultPlaceholder = t("teachers.manage.searchPlaceholder");
      ...
      {showInfo && (
        <div style={{ marginBottom: "1rem" }}>
          <span style={{ fontSize: "0.875rem", color: "#6a6e73" }}>
            {t("teachers.manage.searchResults", { count: resultsCount, total: totalCount })}
          </span>
        </div>
      )}
    </div>
