/**
 * Tests for PlanningFilter.tsx
 *
 * @file PlanningFilter.tsx
 * @type component
...
describe('PlanningFilter', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<PlanningFilter {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<PlanningFilter {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<PlanningFilter {...defaultProps} />);
