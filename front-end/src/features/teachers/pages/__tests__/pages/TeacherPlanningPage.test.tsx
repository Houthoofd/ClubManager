/**
 * Tests for TeacherPlanningPage.tsx
 *
 * @file TeacherPlanningPage.tsx
 * @type page
...
import { TeacherPlanningPage } from '../../TeacherPlanningPage';
...
describe('TeacherPlanningPage', () => {
  const renderPage = (props = {}) => {
    return render(
      <BrowserRouter>
        <MockedProvider mocks={[]} addTypename={false}>
          <TeacherPlanningPage {...props} />
        </MockedProvider>
      </BrowserRouter>
    );
  };
