/**
 * Tests for useOptimisticMutation.ts
 *
...
describe('useOptimisticMutation', () => {
  ...
  describe('Initialization', () => {
    it('should initialize in loading state', () => {
      let result: any;
      try {
        const hookResult = renderHook(() => useOptimisticMutation(), { wrapper });
    ...
    it('should accept initial variables', () => {
      ...
      let result: any;
      try {
        const hookResult = renderHook(() => useOptimisticMutation(variables), { wrapper });
  ...
  describe('Successful Query/Mutation', () => {
    it('should fetch data successfully', async () => {
      ...
      let result: any;
      try {
        const hookResult = renderHook(() => useOptimisticMutation(), {
  ...
  describe('Refetch & Polling', () => {
    ...
    it('should handle polling if enabled', async () => {
      ...
      try {
        ...
        () => useOptimisticMutation({ pollInterval: 5000 }),
        { wrapper: customWrapper }
      );
  ...
  describe('Cleanup', () => {
    it('should cancel pending requests on unmount', async () => {
      ...
      const { result, unmount } = renderHook(() => useOptimisticMutation(), {
        wrapper: customWrapper,
      });
