/**
 * Tests for LanguageSelector.tsx
 *
...
describe('LanguageSelector', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<LanguageSelector {...defaultProps} showDetails={true} />);      // Element should now be visible
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<LanguageSelector {...defaultProps} value="updated" />);      // Updated value should be reflected
