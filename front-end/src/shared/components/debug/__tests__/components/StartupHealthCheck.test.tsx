/**
 * Tests for StartupHealthCheck.tsx
 *
 * @file StartupHealthCheck.tsx
 * @type component
...
describe('StartupHealthCheck', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <StartupHealthCheck {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<StartupHealthCheck {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<StartupHealthCheck {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<StartupHealthCheck {...defaultProps} />);
