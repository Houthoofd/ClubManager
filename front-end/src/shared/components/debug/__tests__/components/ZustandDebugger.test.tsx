/**
 * Tests for ZustandDebugger.tsx
 *
 * @file ZustandDebugger.tsx
 * @type component
...
describe('ZustandDebugger', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<ZustandDebugger {...defaultProps} showDetails={true} />);      // Element should now be visible
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<ZustandDebugger {...defaultProps} value="updated" />);      // Updated value should be reflected
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<ZustandDebugger {...defaultProps} />);      // Component should not re-render unnecessarily
    });
