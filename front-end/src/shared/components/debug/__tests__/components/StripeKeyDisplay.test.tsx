/**
 * Tests for StripeKeyDisplay.tsx
 *
 * @file StripeKeyDisplay.tsx
 * @type component
...
import { StripeKeyDisplay } from '../../StripeKeyDisplay';
...
describe('StripeKeyDisplay', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<StripeKeyDisplay {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<StripeKeyDisplay {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<StripeKeyDisplay {...defaultProps} />);
