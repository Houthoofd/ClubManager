/**
 * Tests for PromotionConfirmModal.tsx
 *
 * @file PromotionConfirmModal.tsx
 * @type component
...
describe('PromotionConfirmModal', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <PromotionConfirmModal {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<PromotionConfirmModal {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<PromotionConfirmModal {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<PromotionConfirmModal {...defaultProps} />);
