/**
 * Tests for TableauStatistiques.tsx
 *
 * @file TableauStatistiques.tsx
 * @type component
...
import { TableauStatistiques } from '../../TableauStatistiques';
...
describe('TableauStatistiques', () => {
  ...
  const renderComponent = (props = {}) => {
    ...
    return render(
      ...
      <TableauStatistiques {...mergedProps} />
      //   </I18nextProvider>
      // </MockedProvider>
    );
  };
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<TableauStatistiques {...defaultProps} showDetails={true} />);
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<TableauStatistiques {...defaultProps} value="updated" />);
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<TableauStatistiques {...defaultProps} />);
