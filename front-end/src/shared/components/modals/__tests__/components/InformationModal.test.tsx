/**
 * Tests for InformationModal.tsx
 *
 * @file InformationModal.tsx
 * @type component
...
describe('InformationModal', () => {
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should conditionally render elements based on props', () => {
      ...
      rerender(<InformationModal {...defaultProps} showDetails={true} />);      // Element should now be visible
  ...
  describe('Integration', () => {
    ...
    it('should handle prop updates', () => {
      ...
      rerender(<InformationModal {...defaultProps} value="updated" />);      // Updated value should be reflected
  ...
  describe('Performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      rerender(<InformationModal {...defaultProps} />);      // Component should not re-render unnecessarily
    });
