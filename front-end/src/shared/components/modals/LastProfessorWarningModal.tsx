...
import ModalConfirmation from "../common-legacy/modal/ModalConfirmation";
      ...
      <div style={{ textAlign: "center", padding: "1rem" }}>
        ...
        >
          <p style={{ fontSize: "0.9rem", color: "#721c24", margin: 0, fontWeight: "bold" }}>
            ⚠️ Attention : Ce cours sera automatiquement supprimé car il n'aura plus de professeur
            assigné.
          </p>
