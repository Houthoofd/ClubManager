  ...
  return {
    ...
    define: {
      ...
      "import.meta.env.VITE_STRIPE_PUBLIC_KEY": JSON.stringify(
        STRIPE_PUBLIC_KEY_FORCE,
      ),
      "import.meta.env.VITE_API_BASE_URL": JSON.stringify(API_BASE_URL_FORCE),
      "import.meta.env.VITE_STRIPE_SOURCE":
        JSON.stringify("vite_config_forced"),
      ...
      "import.meta.env.VITE_CONFIG_TIMESTAMP": JSON.stringify(
