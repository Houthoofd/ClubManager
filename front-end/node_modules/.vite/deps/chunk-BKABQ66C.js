...
function createIcon({ name, xOffset = 0, yOffset = 0, width, height, svgPath, svgClassName }) {
  ...
  return _a = class SVGIcon extends import_react.Component {
    ...
    render() {
      ...
      return (0, import_jsx_runtime.jsxs)("svg", Object.assign({ className: classNames.join(" "), viewBox, fill: "currentColor", "aria-labelledby": hasTitle ? this.id : null, "aria-hidden": hasTitle ? null : true, role: "img", width: "1em", height: "1em" }, props, { children: [hasTitle && (0, import_jsx_runtime.jsx)("title", { id: this.id, children: title }), Array.isArray(svgPath) ? svgPath.map((pathObject, index) => (0, import_jsx_runtime.jsx)("path", { className: pathObject.className, d: pathObject.path }, `${pathObject.path}-${index}`)) : (0, import_jsx_runtime.jsx)("path", { d: svgPath })] }));
    }
...
//# sourceMappingURL=chunk-BKABQ66C.js.map
