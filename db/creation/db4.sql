...
-- Recréer la table commandes avec ON DELETE CASCADE
CREATE TABLE commandes (
    ...
    -- Clé étrangère vers la table des utilisateurs avec ON DELETE CASCADE
...
-- Insérer les jours de la semaine dans la table cours_recurrent
