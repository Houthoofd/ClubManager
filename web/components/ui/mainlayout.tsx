...
const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  return (
    <div className={`layout ${isDarkMode ? 'light' : 'dark'}`}>
      ...
      <div className={`content ${rightSidebarOpen ? 'right-side-open' : 'right-side-close'} ${isLeftNavbarOpen ? 'left-panel-open' : 'left-panel-close'} ${isRightNavbarOpen ? 'right-panel-open' : 'right-panel-close'}`}>
        <nav className={`navigation-left-panel ${isLeftNavbarOpen ? 'open' : 'close'} ${isDarkMode ? 'light' : 'dark'}`}>
          <div className='top-nav'>
            <ExpandMenu
              icon={<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M840-280v-276L480-360 40-600l440-240 440 240v320h-80ZM480-120 200-272v-200l280 152 280-152v200L480-120Z"/></svg>}
              text="Cours"
          ...
          <div className='botton-nav'>
            <ExpandMenu
              icon={<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m370-80-16-128q-13-5-24.5-12T307-235l-119 50L78-375l103-78q-1-7-1-13.5v-27q0-6.5 1-13.5L78-585l110-190 119 50q11-8 23-15t24-12l16-128h220l16 128q13 5 24.5 12t22.5 15l119-50 110 190-103 78q1 7 1 13.5v27q0 6.5-2 13.5l103 78-110 190-118-50q-11 8-23 15t-24 12L590-80H370Zm112-260q58 0 99-41t41-99q0-58-41-99t-99-41q-59 0-99.5 41T342-480q0 58 40.5 99t99.5 41Z"/></svg>}
              text="Settings"
        ...
        <div className={`main-content ${isLeftNavbarOpen ? 'left-panel-open' : 'left-panel-close'} ${isDarkMode ? 'light' : 'dark'} ${isMainRightSidePanelOpen ? 'right-side-panel-close' : 'right-side-panel-open'}`}>
