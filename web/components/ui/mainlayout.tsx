          ...
          <ul className={`${isLeftNavbarOpen ? 'open' : 'close'}`}>
            ...
            <li className={`menu-list-item ${isLeftNavbarOpen ? 'open' : 'close'}`}>
              <Link className={`menu-list-item-link ${isLeftNavbarOpen ? 'open' : 'close'}`} to="/pages/cours">
                ...
                <div className={`menu-list-item-text ${isLeftNavbarOpen ? 'open' : 'close'}`}>Account</div>
              </Link>
            </li>
            <li className={`menu-list-item ${isLeftNavbarOpen ? 'open' : 'close'}`}>
              <Link className={`menu-list-item-link ${isLeftNavbarOpen ? 'open' : 'close'}`} to="/pages/cours">
            ...
            <li className={`menu-list-item ${isLeftNavbarOpen ? 'open' : 'close'}`}>
              <Link className={`menu-list-item-link ${isLeftNavbarOpen ? 'open' : 'close'}`} to="/pages/store">
                ...
                <div className={`menu-list-item-text ${isLeftNavbarOpen ? 'open' : 'close'}`}>Store</div>
              </Link>
            </li>
          </ul>
          <ul className={`${isLeftNavbarOpen ? 'open' : 'close'}`}>
